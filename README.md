...
We appreciate [verl]([https://github.com/facebookresearch/llama](https://github.com/volcengine/verl)), [TinyZero]([https://github.com/huggingface/transformers/tree/main/src/transformers/models/llama](https://github.com/Jiayi-Pan/TinyZero)), and many other related works for their open-source contributions. The logo of the model is automatically generated by [GPT-4o]([https://yige.baidu.com/lab](https://openai.com/index/hello-gpt-4o/)).
