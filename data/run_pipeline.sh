...
RAW_H5AD_DIR="/data/Mamba/Project/Single_Cell/Benchmark/Cell_Type/Cell-O1/A013/processed_data"

# Directory to save single-cell level JSON output (Step 1)
CELL_JSON_DIR="/data/Mamba/Project/Single_Cell/Benchmark/Cell_Type/Cell-O1/A013/processed_data/cell_metadata"

# Directory to save QA-formatted batch data (Step 2)
BATCH_QA_DIR="/data/Mamba/Project/Single_Cell/Benchmark/Cell_Type/Cell-O1/A013/processed_data/batch_qa"

# Directory to save final LLM-ready data (Step 3)
FINAL_OUTPUT_DIR="/data/Mamba/Project/Single_Cell/Benchmark/Cell_Type/Cell-O1/A013/processed_data/final_llm_input"
